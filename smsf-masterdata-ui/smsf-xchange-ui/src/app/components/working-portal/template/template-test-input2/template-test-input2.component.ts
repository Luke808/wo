...
@Component({
selector: 'app-working-portal-template-test-input2',
templateUrl: './template-test-input2.component.html'
})
export class TemplateTestInput2Component implements OnInit, MyTemplate {
