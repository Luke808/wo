...
@Component({
selector: 'app-working-portal-template-test-input3',
templateUrl: './template-test-input3.component.html'
})
export class TemplateTestInput3Component implements OnInit, MyTemplate {
